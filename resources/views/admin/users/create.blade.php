...
@section('content')
    <div class="mb-6">
        <x-common.page-breadcrumb pageTitle="Nuevo Usuario" />
    </div>

    <div class="max-w-2xl"
         x-data="{
             roleNeedsLocation: false,
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-100">
                <h3 class="text-lg font-black text-gray-900 uppercase tracking-tight">Nuevo Usuario</h3>
                <p class="text-xs text-gray-500 font-bold">Complete los campos para registrar el acceso</p>
            </div>
...
@push('scripts')
<script>
    // Re-check role on page load if old() values exist (validation fail)
    document.addEventListener('DOMContentLoaded', () => {
        const sel = document.querySelector('select[name="role_id"]');
        if (sel && sel.value) {
